...
nissl_volume_location = 'C:\Drive\Histology\for tutorial\nissl_volume_10um.npy';

nv = readNPY(nissl_volume_location);
...
f = AtlasTransformBrowser_testnissl(f, nv,av,st, slice_figure_browser, processed_images_folder, probe_save_name_suffix); 
